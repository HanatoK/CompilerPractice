...
public:
  ...
  virtual std::vector<std::shared_ptr<SymbolTableEntryImplBase>> parseIdentifierSublist(
      std::shared_ptr<PascalToken> token, const TokenTypeSet& follow_set, const TokenTypeSet& comma_set);
